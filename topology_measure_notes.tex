...
\begin{proof}
    ...
    \emph{Equalisers}: Let $f,g \colon X \to Y$ be any parallel homomorphisms, and let $S$ be the subset of $X$ on which they agree. If $h \colon Z \to X$ is any homomorphism such that $f \circ h = g \circ h$, then there is a unique homomorphism $u \colon Z \to S$ such that the following diagram commutes:
    %
    \begin{equation*}
        \begin{tikzcd}
            S
