...
\begin{examplebreak}[Disjoint unions]
    If $(X_\alpha)_{\alpha \in A}$ is a collection of structured sets, we equip the disjoint union $X = \coprod_{\alpha \in A} X_\alpha$ with the final structure coinduced by the inclusions $\iota_\alpha \colon X_\alpha \to X$.
...
\begin{proposition}[Composition of final structures]
...
\begin{proposition}[Final structures as quotient structures]
    ...
    Let $f_\alpha \colon X_\alpha \to Y$ for $\alpha \in A$ be homomorphisms, let $X = \coprod_{\alpha \in A} X_\alpha$, and let $f \colon X \to Y$ be the unique homomorphism such that $f_\alpha = f \circ \iota_\alpha$:
    %
    \begin{equation*}
        \begin{tikzcd}
            X_\alpha
                \ar[d, "\iota_\alpha", swap]
                \ar[dr, "f_\alpha"] \\
            X
                \ar[r, "f", swap]
            & Y
